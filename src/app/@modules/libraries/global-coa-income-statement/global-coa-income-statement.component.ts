...
@Component({
  selector: 'app-global-coa-income-statement',
  templateUrl: './global-coa-income-statement.component.html',
  styleUrls: ['./global-coa-income-statement.component.scss'],
  providers: [BalanceSheetTreeService]
})
export class GlobalCoaIncomeStatementComponent implements OnInit {
  ...
  getIncomeStatement() {
    ...
    this.balanceSheetTreeService.getIncomeStatement(this.chartOfAccount, CoaType.Global).subscribe(data => {
      if (data.length > 0) {
  ...
  saveIncomeStatement() {
    ...
    this.balanceSheetTreeService.saveIncomeStatement(this.chartOfAccount, CoaType.Global).subscribe(data => {
